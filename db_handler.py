...
class User(Base):
    ...
    received_messages = relationship('Message', foreign_keys='Message.recepient_id', back_populates='recipient')
...
class Message(Base):
    ...
    recepient_id = Column(Integer, ForeignKey('users.id', ondelete='CASCADE'))

    sender = relationship('User', foreign_keys=[sender_id], back_populates='sent_messages')
    recipient = relationship('User', foreign_keys=[recepient_id], back_populates='received_messages')
...
class VacancyMedia(Base):
    ...
    vacancy_id = Column(Integer, ForeignKey('vacancy.id', ondelete='CASCADE'), primary_key=True)
    media_id = Column(Integer, ForeignKey('media.id', ondelete='CASCADE'), primary_key=True)
